import 'package:aplikasi_klambi/detail_profile.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  // Perform some action when the user returns from the profile page
      print('User returned from profile page');
      // You can also update the UI or perform any other action here
});
                    },
                    child: Card(
